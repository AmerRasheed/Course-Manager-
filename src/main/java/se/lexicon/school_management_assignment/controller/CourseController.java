...
import se.lexicon.school_management_assignment.data.service.course.CourseService;
import se.lexicon.school_management_assignment.data.service.student.StudentService;
import se.lexicon.school_management_assignment.dto.forms.CreateCourseForm;
import se.lexicon.school_management_assignment.dto.forms.UpdateCourseForm;
...
import se.lexicon.school_management_assignment.exception.ResourceNotFoundException;
    ...
    public String find(
        ...
        switch (type){
            case "name":
                ...
                if(courseViews.isEmpty()) model.addAttribute("message", message);
                break;
